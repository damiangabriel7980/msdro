app.controllerProvider.register('ConferenceController',['$scope','ActionModal',function($scope,ActionModal){
 ...
 $scope.showMessages = false;
  ...
  navigator.getUserMedia = ( navigator.getUserMedia ||
   ...
   $scope.exitConferences = function(){
     ActionModal.show("Iesiti din conferinta","Sunteti sigur ca doriti sa iesiti din conferinta",function(){
       console.log("ati iesit din conferinta");
     },{
       yes:"Da"
     })
   };
