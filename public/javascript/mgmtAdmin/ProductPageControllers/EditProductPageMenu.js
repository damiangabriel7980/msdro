controllers.controller('EditProductPageMenu', ['$scope', 'SpecialProductsService', 'AmazonService', 'Success', 'tinyMCEConfig', function($scope, SpecialProductsService, AmazonService, Success, tinyMCEConfig) {
