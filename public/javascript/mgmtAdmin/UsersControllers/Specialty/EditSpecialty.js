controllers.controller('EditSpecialtyController', ['$scope', '$modalInstance', 'SystemService', '$modal', '$state', 'Success', 'specialty', 'ManageSpecialtyService', function ($scope, $modalInstance, SystemService, $modal, $state, Success, specialty, ManageSpecialtyService) {
