controllers.controller('UsersRejected', ['$scope', '$rootScope', '$filter', 'ngTableParams', '$modal', 'NewAccountsService', 'Success', 'Error', function($scope, $rootScope, $filter, ngTableParams, $modal, NewAccountsService, Success, Error){
