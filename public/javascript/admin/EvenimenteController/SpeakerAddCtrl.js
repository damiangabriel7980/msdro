 ...
 */
cloudAdminControllers.controller('SpeakerAddCtrl', ['$scope','$rootScope' ,'EventsAdminService','$stateParams','$sce','$filter', function($scope,$rootScope,EventsAdminService,$stateParams,$sce,$filter){
